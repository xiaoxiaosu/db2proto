...
var DBTypeToPbType = map[string] string {
	"int": "int32",
	"tinyint": "int8",
	"smallint": "int",
	"mediumint": "int64",
...
func (m *DBModel) GetColumns(dbName, tableName string) ([]*TableColumn, error) {
	...
	for rows.Next() {
		...
		err := rows.Scan(&column.ColumnName, &column.DataType, &column.ColmunKey, &column.IsNullable, &column.ColumnType, &column.ColumnComment)
		if err != nil {
			return nil, err
		}
